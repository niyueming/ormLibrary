...
package net.nym.ormlibrary.operation;
...
//    <T> int update(Collection<T> collection, ColumnsValue cvs, ConflictAlgorithm conflictAlgorithm);
    <T> int update(Collection<T> collection, String[] columns);
...
//    int update(WhereBuilder builder, ColumnsValue cvs, ConflictAlgorithm conflictAlgorithm);
    <T> int update(Class<T> claxx,String where, Object[] whereArgs, String[] columns, Object[] values);
...
//    int delete(WhereBuilder where);
    <T> int delete(Class<T> claxx, String where, Object[] whereArgs);
...
//    <T> ArrayList<T> query(QueryBuilder<T> qb);
    <T> ArrayList<T> query(Class<T> claxx,String where, Object... whereArgs);
